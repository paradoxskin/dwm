...
static const char col_orange[]      = "#e69138";
...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_Delete,                  spawn,          SHCMD("~/.scripts/sleep") },
    ...
    { MODKEY,                       XK_semicolon,               goprevvis,      {0} },
    { MODKEY,                       XK_apostrophe,              gonextvis,      {0} },
    { MODKEY|ShiftMask,             XK_semicolon,               goprev,         {0} },
    { MODKEY|ShiftMask,             XK_apostrophe,              gonext,         {0} },
