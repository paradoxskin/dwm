...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_l,            spawn,          SHCMD("~/.scripts/sleep.sh") },
    { MODKEY,                       XK_minus,        spawn,          SHCMD("~/.scripts/orangeScreen.sh") },
    { 0,                            XK_Print,        spawn,          SHCMD("~/.scripts/capture.sh") },
    { MODKEY,                       XK_Delete,       spawn,          SHCMD("slock") },
    { MODKEY|ShiftMask,             XK_Delete,       spawn,          SHCMD("~/.scripts/deepsleep.sh") },
